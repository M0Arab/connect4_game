...
export default function ConnectFour({p1Name,p2Name}) {
  ...
  return (
    <>
      ...
      {!win && (
        <h2 style={{ color: currentPlayer, border: "2px solid black", width: "fit-content" , marginLeft: "45%", padding : "10px"}}>
          {currentPlayer === boardSettings.colors.p1 ?p1Name : p2Name}
        </h2>
      )}
      {win && (
        <>
